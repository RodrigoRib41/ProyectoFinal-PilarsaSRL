...
export default function HeroBaic() {
  return (
    <div className="relative w-full h-[35vh] lg:h-[800px] md:h-[600px] md:min-h-[500px] sm:min-h-[calc(80vh-60px)] overflow-hidden">
      ...
      <Image
        src="/modelos/eu5/EU5primera.jpg" // ← asegurate que esta ruta esté bien en /public
        alt="Hero BAIC EU5"
        fill
      ...
      >
            ...
            <p className="text-sm md:text-2xl">
                Desde su diseño aerodinámico hasta sus líneas elegantes, este vehículo cautiva con su presencia.
            </p>
      </div>
    </div>
  );
