...
export default function HeroBaic() {
  return (
    <div className="relative w-full h-[35vh] lg:h-[800px] md:h-[600px] md:min-h-[500px] sm:min-h-[calc(80vh-60px)] overflow-hidden">
      ...
      <Image
        src="/modelos/eu5/EU5sexta.jpg" // ← asegurate que esta ruta esté bien en /public
        alt="Hero BAIC EU5"
        fill
      ...
      >
            <h1 className="text-base md:text-4xl font-semibold mb-2">
                PANTALLA MULTIMEDIA DE 9&quot;
            </h1>
            <p className="text-sm md:text-2xl">
                Con una interfaz intuitiva y funciones inteligentes,
                disfrutá del control total mientras navegás con estilo y seguridad.
            </p>
      </div>
    </div>
  );
