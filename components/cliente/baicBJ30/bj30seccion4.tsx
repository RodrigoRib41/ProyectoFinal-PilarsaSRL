...
const items = [
  {
    ...
    label: "Diseño Frontal Familiar",
    description:
      "Combina un diseño robusto con tecnología avanzada para ofrecer una experiencia de conducción versátil y eficiente.",
  },
  {
    src: "/modelos/bj30/BJ30tercera2.jpg",
    label: "Diseño Traseros Robusto",
    description:
      "La luz trasera vertical cuenta con un patrón en doble-D, lo que la hace aún más reconocible.",
  },
];
