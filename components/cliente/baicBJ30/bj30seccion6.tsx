...
const items = [
  {
    ...
    description:
      "Combinacion de doble pantalla de 10.25 pulgadas + 14.6 pulgadas.",
  },
  {
    src: "/modelos/bj30/BJ30quinta2.jpg",
    label: "Sistema de control todoterreno ATS",
    description:
      "Optimiza automaticamente los sistemas de control del vehiculo para adaptarse a diferentes tipos de terrenos.",
  },
];
