...
export default function HeroBaic() {
  return (
    <div className="relative w-full h-[35vh] lg:h-[800px] md:h-[600px] md:min-h-[500px] sm:min-h-[calc(80vh-60px)] overflow-hidden">
      ...
      <Image
        src="/modelos/u5PLUS/U5segunda.jpg" // ← asegurate que esta ruta esté bien en /public
        alt="Hero BAIC U5"
        fill
      ...
      >
            <h1 className="text-base md:text-4xl font-semibold mb-2">
                Excelente coeficiente aerodinámico (0.28)
            </h1>
            <p className="text-sm md:text-2xl">
                Disminución del consumo de combustible de manera eficiente y una mejor estabilidad en el camino.
            </p>
      </div>
    </div>
  );
